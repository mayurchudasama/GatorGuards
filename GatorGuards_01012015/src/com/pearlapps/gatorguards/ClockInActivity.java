...
public class ClockInActivity extends Activity implements OnClickListener,
					...
					do {
						...
						try {
							String postBody = KEY_ID + "="
									...
									+ "&" + KEY_COST_CODES + "="
									+ URLEncoder.encode(cost_code, "UTF-8")
									+ "&" + KEY_TIME_IN + "="
									+ URLEncoder.encode(time_in, "UTF-8") + "&"
									+ KEY_TIME_OUR + "="
									+ URLEncoder.encode(time_out, "UTF-8");
	...
	public void onClick(View v) {
		...
		case R.id.tvStop:
			...
			if (lastId >= 0) {
				int success = helper.insertTimeOut(dateNow, lastId + "");
				if (success == 1) {
